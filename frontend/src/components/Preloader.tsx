          ...
          <div className="flex flex-col items-center gap-8 overflow-hidden">
            <div className="flex gap-4 text-5xl md:text-7xl font-black tracking-tighter text-white">
              <motion.span
                ...
                animate={{ y: '0%' }}
                transition={{ duration: shouldReduceMotion ? 0.2 : 1, ease: customEase, delay: shouldReduceMotion ? 0 : 0.1 }}
              >
                GIF
              </motion.span>
              ...
              <motion.span
                initial={shouldReduceMotion ? false : { y: '100%' }}
                animate={{ y: '0%' }}
                transition={{ duration: shouldReduceMotion ? 0.2 : 1, ease: customEase, delay: shouldReduceMotion ? 0 : 0.2 }}
            ...
            <div className="overflow-hidden">
              <motion.div
                initial={shouldReduceMotion ? false : { y: '100%' }}
                animate={{ y: '0%' }}
                transition={{ duration: shouldReduceMotion ? 0.2 : 1.2, ease: customEase, delay: shouldReduceMotion ? 0 : 0.3 }}
              >
                <AsciiTextScramble 
                  text={BIG_ASCII_ART} 
